...
$friend_id=$_GET['frn_id'];
$content_id=$_GET['content_id'];
$choice=$_GET['choice'];
//$comment=$_GET['com'];
if($choice==1)
{
$lquery="insert into liked_content values ('','$id','$friend_id','$content_id')";
mysql_query($lquery);
echo " You liked ".$friend_id."contents";
					...
					echo "<li>";
						echo"<div>";
							...
							echo"<div>";
								...
								echo"<a href=\"like.php?frn_id=".$fid."&amp;content_id=".$row['content_id']."\"> Like</a>&nbsp;&nbsp;";
